...
function buildHtml(id, dat) {
    ...
    let file = '<html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="styles.css"><link rel="icon" href="icon.ico" /><title>Stock-Manager</title></head>' +
        '<body><br><label><input name="mode" type="checkbox" style="width: 20px; height: 20px;" onclick="darkmode()">  Dark mode</label><br><center><a href="/home.html"><img width="100" height="100" src="icon.ico"></a><h1>Stock Manager v1.6.0</h1></center><br>';
    let x = 0;
    das.forEach(function (value) {
        if (value.barcode == id && value.date == date2) {
            ...
            if (x == 0 && index != null) {
                ...
                file += '<center><div style="overflow-x:auto;"><table>' +
                    ...
                    '</div><br><br><center><p style="margin: 15px">Made with <span style="color: #e25555;">&hearts;</span> by JeyyJeyy</p></center><script src="app.js"></script></body></html>';
                x++
            }
        }
    })
