...
function buildHtml(id, dat) {
    ...
    '<body><label class="switch"><input type="checkbox" checked="" onclick="darkmode()"><span class="slider"></span></label><br><center><a href="/home.html"><img width="100" height="100" src="icon.ico"></a><h1>Stock Manager v1.4.14</h1></center><br>';
    let x = 0;
    das.forEach(function (value) {
