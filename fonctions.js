...
function buildHtml(num) {
    ...
    if (id != null) {
        ...
        file += '<center style="overflow-x:auto;"><table>' +
            ...
            '<td><button onclick="added(' + id + ',' + dat + ',' + 1 + ')"><b>Ajouter</b></button><br><br><button onclick="delet(' + id + ',' + dat + ',1)"><b>Supprimer</b></button><br><br><button onclick="gohome()"><b>Retour</b></button></td>' +
